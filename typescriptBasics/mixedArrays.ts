...
let mixedArray1:[string,number] = ['bilal',4];
let mixedArray2:[string,number,boolean] = ['ammar',10,true];
let mixedArray3:[string,number,boolean,Array<string>] = ['ammar',10,true,["Mohib-ul-Nabi","Attiqa","Bilal","Ammar"]];
